    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        <Image
          ...
          source={require("../assets/img/iconEyeBall.png")}
        />
        <View style={styles.sectionInputN}>
          <Image
            style={{ width: "30px", height: "30px" }}
            source={require("../assets/img/logoAvatar.png")}
          />
          <TextInput
            style={{
              color: "#C4C4C4",
        ...
        <View style={styles.sectionInputP}>
          <Image
            style={{ width: "30px", height: "30px" }}
            source={require("../assets/img/logoLock.png")}
          />
          <TextInput
            style={{
              color: "#C4C4C4",
        ...
        <View style={{ flexDirection: "row", gap: "50px", marginTop: "24px" }}>
          <Image
            ...
            source={require("../assets/img/logoAdd.png")}
          />
          <Image
            style={{ width: "74px", height: "74px" }}
            source={require("../assets/img/logoWifi.png")}
          />
          <View
            style={{
              width: "74px",
          ...
          >
            <Image
              ...
              source={require("../assets/img/logoFB.png")}
            />
          </View>
        </View>
      </View>
